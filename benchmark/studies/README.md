...
type: module-readme
module: benchmark/studies
---

# `studies/` — frozen benchmark spikes

Completed or abandoned evaluation spikes, kept as reference. Each is parked, not maintained; its durable findings are in [`../JOURNAL.md`](../JOURNAL.md). The live, reusable harness stays at the [benchmark root](../README.md) (`lib/`, `prompts/`, `viewers/`, the corpus builders) — these folders are the past, not the toolkit.
