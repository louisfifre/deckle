...
- **home:** Watering retires from the surface  property and verb removed

### Fixed

- **home:** Ignore Anytype's link graph in the delete reference guard
...
- **lighting:** Contain late DNS-SD callbacks
...
- **audio:** Centralize level window defaults
