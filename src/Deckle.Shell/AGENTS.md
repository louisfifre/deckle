...
The tray icon's idle ↔ recording state is pushed in by the host App through `UpdateStatus`; it is never inferred from the localized status text here — the shell doesn't know what recording means.
