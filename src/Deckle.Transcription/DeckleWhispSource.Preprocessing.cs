...
public sealed partial class DeckleWhispSource
{
    ...
    // same family as the VAD trim. PreprocessedTelemetryRecorded is the distribution
    // rollup of the processed signal — the post-DSP mirror of DeckleAudioSource's raw
