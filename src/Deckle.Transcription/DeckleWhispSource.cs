...
public sealed partial class DeckleWhispSource : DeckleEventSource
{
    ...
    public const int EvtTranscribePromptConfigured       = 167;
    public const int EvtTranscribeRepetitionLoopMetrics  = 168;
    public const int EvtSegmentRecognized                = 169;
    public const int EvtDictationPasted                  = 170;
    public const int EvtDictationCopied                  = 171;
    public const int EvtFileTranscriptionCompleted       = 172;
    public const int EvtFileTranscriptionCopied          = 173;
    public const int EvtMicrophoneUnavailable            = 174;
    public const int EvtMicrophoneUnavailableDetail      = 175;
    public const int EvtMicrophoneRecovered              = 176;
    public const int EvtModelUnavailable                 = 177;
    public const int EvtModelUnavailableDetail           = 178;
    public const int EvtModelRecovered                   = 179;

    // ── Per-provider keywords ───────────────────────────────────────────
    // 0x400 belonged to the retired operational transcript event. Keep the bit
    // reserved so historical traces remain unambiguous; user content now lives
    // exclusively in consented Dataset observations.
