...
internal static class CorrectionBenchmarkCorpus
{
    public static IReadOnlyList<CorrectionBenchmarkCase> All { get; } = new[]
    {
        ...
        Case("participle_after_avoir", "verb-ending", 0, 1, "j'ai manger trop vite", "j'ai mangé trop vite"),
        Case("infinitive_after_vais", "verb-ending", 0, 0, "je vais manger ce soir", "je vais mangé ce soir"),
        Case("infinitive_after_pour", "verb-ending", 0, 0, "je passe pour vérifier", "je passe pour vérifié"),
        Case("participle_c_est", "verb-ending", 0, 1, "c'est arriver hier", "c'est arrivé hier"),
        Case("infinitive_il_faut", "verb-ending", 0, 0, "il faut corriger ce texte", "il faut corrigé ce texte"),
        Case("participle_adjective_trap", "verb-ending", 0, 0, "il n'y a rien de cassé", "il n'y a rien de casser"),
        Case("second_plural_present", "verb-ending", 0, 0, "vous testez demain", "vous tester demain"),
        Case("infinitive_after_pouvez", "verb-ending", 0, 1, "vous pouvez testez demain", "vous pouvez tester demain"),

        Case("feminine_singular", "agreement", 0, 1, "la porte est ouvert", "la porte est ouverte"),
        Case("masculine_singular", "agreement", 0, 0, "un fichier ouvert reste visible", "un fichier ouverte reste visible"),
        Case("feminine_plural_participle", "agreement", 0, 1, "les données sont stocké localement", "les données sont stockées localement"),
        Case("masculine_plural_participle", "agreement", 0, 1, "les fichiers sont ouvert", "les fichiers sont ouverts"),
        Case("feminine_plural_subject", "agreement", 0, 1, "elles sont parti tôt", "elles sont parties tôt"),
        Case("masculine_plural_subject", "agreement", 0, 0, "ils sont partis tôt", "ils sont parties tôt"),
