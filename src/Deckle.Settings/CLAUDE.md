...
| `TranscriptionSettingsService` | `modules/transcription/settings.json` | Transcription orchestrator + active backend settings (migrated from legacy `modules/whisp/`) |
