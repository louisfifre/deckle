...
The audition that chose Chatterbox is journaled in `benchmark/asr/JOURNAL.md` (Chatterbox in, Orpheus out, pure ONNX proven). The build plan and its frozen constraints live in the module `CLAUDE.md` and the Anytype task « Synthèse vocale — portage ONNX ».
