...
│   │   ├── research--anytype-backlog-audit--2026-07-27.html
...
│   │   ├── AGENTS.md  — [agent-instructions] ONNX Runtime CPU inference substrate — isolates the process-wide OnnxRuntime de…
│   │   ├── CLAUDE.md
...
│   │   ├── Deckle.Travel.csproj
│   │   ├── DeckleTravelSource.cs
│   │   ├── JOURNAL.md
│   │   ├── TravelGestures.cs
│   │   ├── TravelMcp.cs
│   │   ├── TravelObjects.cs
│   │   ├── TravelPropertyWriter.cs
│   │   ├── TravelRequests.cs
│   │   ├── TravelRuntimeProvider.cs
│   │   ├── TravelSchema.cs
│   │   ├── TravelSchemaRuntime.cs
│   │   ├── TravelTerms.cs
│   │   └── TravelToolCatalog.cs
│   ├── Deckle.Vad/
│   │   ├── AGENTS.md
│   │   ├── CLAUDE.md
│   │   ├── Deckle.Vad.csproj
