...
│   └── skills/
│       ├── deckle-commits/
│       │   └── SKILL.md  — deckle-commits Commit doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carries the…
│       ├── deckle-journal/
│       │   └── SKILL.md  — deckle-journal [skill] Journal doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carries th…
│       ├── deckle-logging/
│       │   ├── SKILL.md  — deckle-logging Observability doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carr…
│       │   └── taxonomy.md
│       ├── deckle-modularite/
│       │   └── SKILL.md  — deckle-modularite Modularity and splitting doctrine for the Deckle project (Windows .NET 10 / Win…
│       ├── deckle-nomenclature/
│       │   ├── SKILL.md  — deckle-nomenclature Naming doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carries cas…
│       │   └── taxonomie.md
│       ├── deckle-settings-ux/
│       │   └── SKILL.md  — deckle-settings-ux User experience doctrine for the settings surfaces of the Deckle project (Windo…
│       ├── deckle-testing/
│       │   └── SKILL.md  — deckle-testing Testing doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carries th…
│       ├── deckle-workflow/
│       │   └── SKILL.md  — deckle-workflow Workflow doctrine for the Deckle project (Windows .NET 10 / WinUI 3). Carries h…
│       ├── microsoft-docs/
...
│   │   ├── 0013-format-canonique-des-artefacts-agents.md  — adr-0013-format-canonique-artefacts-agents [adr] Acte le format normatif des artefacts agents Deckle : langue anglaise par défau…
│   │   ├── 0014-poc-evaluation-voxtral.md
│   │   ├── 0015-attendre-le-merge-mmvq-vulkan-q3-k-q6-k.md
│   │   ├── 0016-inference-safetensors-native-pour-voxtral.md  — adr-0016-inference-safetensors-native-pour-voxtral [adr] Acte l'adoption de l'inférence safetensors-native via Transformers + torch ROCm…
│   │   └── 0017-symetrie-fenetre-telemetrie-et-rotation-du-journal.md  — adr-0017-symetrie-fenetre-telemetrie-et-rotation-du-journal [adr] Acte que le journal applicatif persisté app.jsonl devient le miroir auto-descri…
│   ├── reference/
