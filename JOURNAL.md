...
**Référence normative** : [ADR-0013](docs/adr/0013-format-canonique-des-artefacts-agents.md) pour la décision, et `save-context/format.md` (skill global sous `~/.claude/skills/save-context/`) pour le format technique réutilisable par d'autres skills.
