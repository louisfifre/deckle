...
'@
    ...
    & (Join-Path $PSScriptRoot 'changelog.ps1') -Target $root -OutFile $changelog
    ...
    & (Join-Path $PSScriptRoot 'record-version.ps1') -Target $root -Bump patch
    ...
    & (Join-Path $PSScriptRoot 'record-release.ps1') -Target $root -Version 0.13.1
