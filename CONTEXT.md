...
## Observability — admission vs view

Two controls can make the LogWindow quieter, but they act on opposite sides of the journal boundary. The distinction is whether an observation still exists after the control acts.
